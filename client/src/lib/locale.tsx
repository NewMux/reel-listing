...
export const copy = {
  en: {
    ...
    home: {
      ...
      showcaseMoreEyebrow: "The full listing", showcaseMoreTitle: "Every room, transformed.", showcaseMoreBody: "The same property, rendered room by room with Reel Listing.",
  ...
  ar: {
    ...
    home: {
      ...
      showcaseMoreEyebrow: "العرض الكامل", showcaseMoreTitle: "كل غرفة، تتحوّل.", showcaseMoreBody: "العقار نفسه، تمت معالجته غرفة بغرفة مع Reel Listing.",
