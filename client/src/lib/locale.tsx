...
export const copy = {
  en: {
    ...
    home: {
      ...
      body: "VistaFlow crafts refined, ready-to-share walkthroughs from your property media — with the approval and control your brand deserves.",
      ...
      steps: ["Add 10 property photos", "Set your listing brief", "Review the direction", "Receive your film"],
    ...
    legal: { termsTitle: "Terms of Service", privacyTitle: "Privacy Policy", updated: "Last updated: August 2026", termsIntro: "These terms describe the agreement for using VistaFlow AI. By creating an account or submitting property media, you agree to use the platform lawfully and with the appropriate rights to the content you provide.", privacyIntro: "This policy explains how VistaFlow AI handles account information, project metadata, and media submitted through the platform. We use this information to provide the service, maintain security, and improve the product." },
    dashboard: { greeting: "Good to see you", title: "Your projects", body: "Create, review, and deliver listing films from one quiet workspace.", newProject: "New project", emptyTitle: "Your next listing deserves its close-up.", emptyBody: "Start a project with exactly 10 property photos. You will have a chance to review the direction before production begins.", emptyAction: "Start a project", statuses: "Project stages", view: "View project", recent: "Recently updated" },
    upload: { eyebrow: "New project", title: "Set the scene.", body: "Add property imagery and the short listing brief your project needs.", media: "Property photos", mediaHint: "Upload exactly 10 property photos. JPG, PNG, or WEBP; up to 25 MB combined.", photoCount: "photos selected", photoCountReady: "Ready for review", photoCountRemaining: "more to go", drop: "Drop your media here", browse: "or browse files", titleField: "Property title", titlePlace: "e.g. Seafront penthouse in Palm Jumeirah", description: "Listing description", descriptionPlace: "A few details to anchor the story…", location: "Location", locationPlace: "Dubai Marina, Dubai", continue: "Create project", processing: "Preparing your project…", remove: "Remove" },
    review: { eyebrow: "Review project", title: "Shape the story before it moves.", body: "Review the uploaded property photos. Approve the shot direction to begin AI production, or leave a note for a change.", approve: "Approve & begin generation", request: "Request changes", note: "What would you like changed?", notePlace: "For example: lead with the terrace, then follow with the main living space.", send: "Send request", media: "Property photos", storyboard: "AI shot direction", storyboardBody: "Each photo becomes one 10-second cinematic clip. The order below is preserved in the final reel.", changeSent: "Change request saved" },
    project: { back: "All projects", delivery: "Project delivery", overview: "Generation overview", estimate: "Estimated completion", reviewEstimate: "Awaiting your approval", processingEstimate: "About 8 minutes", doneEstimate: "Ready for delivery", uploadingEstimate: "Securing your media", download: "Download video", share: "Share", unavailable: "Delivery is available as soon as your film is complete.", requestNotes: "Latest change request" },
  ...
  ar: {
    ...
    home: {
      eyebrow: "لعروض تستحق نظرة ثانية", title: "حوّل صور العقار إلى فيلم يتذكره المشترون.", body: "تُنشئ VistaFlow جولات عقارية راقية وجاهزة للمشاركة من وسائطك — مع المراجعة والتحكم اللذين تستحقهما علامتك التجارية.", start: "إنشاء مشروع", watch: "اكتشف كيف تعمل", trusted: "مصممة لفرق العقارات الطموحة في الخليج وما بعده.",
      ...
      flowEyebrow: "من الوسائط إلى الأثر", flowTitle: "أربع خطوات بسيطة.", steps: ["أضف 10 صور للعقار", "حدّد موجز العرض", "راجع الاتجاه", "استلم فيلمك"], ctaTitle: "امنح عقارك التالي الاهتمام الذي يستحقه.", ctaBody: "طريقة هادئة لإنتاج فيديو عقاري متميز دون إبطاء فريقك.", ctaButton: "ابدأ مشروعاً",
    },
