...
export const copy = {
  en: {
    ...
    home: {
      ...
      steps: ["Add property media", "Set your listing brief", "Review the direction", "Receive your film"],
    ...
    dashboard: { greeting: "Good to see you", title: "Your projects", body: "Create, review, and deliver listing films from one quiet workspace.", newProject: "New project", emptyTitle: "Your next listing deserves its close-up.", emptyBody: "Start a project with a set of property images or a walkthrough video. You will have a chance to review the direction before production begins.", emptyAction: "Start a project", statuses: "Project stages", view: "View project", recent: "Recently updated" },
    upload: { eyebrow: "New project", title: "Set the scene.", body: "Add property imagery and the short listing brief your project needs.", media: "Property media", mediaHint: "Upload 3–10 images or one walkthrough video. JPG, PNG, WEBP, MP4 or MOV; up to 25 MB combined.", drop: "Drop your media here", browse: "or browse files", titleField: "Property title", titlePlace: "e.g. Seafront penthouse in Palm Jumeirah", description: "Listing description", descriptionPlace: "A few details to anchor the story…", location: "Location", locationPlace: "Dubai Marina, Dubai", continue: "Create project", processing: "Preparing your project…", remove: "Remove" },
    review: { eyebrow: "Review project", title: "Shape the story before it moves.", body: "Review the uploaded property media. Approve the direction to begin AI production, or leave a note for a change.", approve: "Approve & begin generation", request: "Request changes", note: "What would you like changed?", notePlace: "For example: lead with the terrace, then follow with the main living space.", send: "Send request", media: "Property media", changeSent: "Change request saved" },
  ...
  ar: {
    ...
    home: {
      ...
      flowEyebrow: "من الوسائط إلى الأثر", flowTitle: "أربع خطوات بسيطة.", steps: ["أضف وسائط العقار", "حدّد موجز العرض", "راجع الاتجاه", "استلم فيلمك"], ctaTitle: "امنح عقارك التالي الاهتمام الذي يستحقه.", ctaBody: "طريقة هادئة لإنتاج فيديو عقاري متميز دون إبطاء فريقك.", ctaButton: "ابدأ مشروعاً",
    },
    ...
    dashboard: { greeting: "سعداء برؤيتك", title: "مشاريعك", body: "أنشئ وراجع وسلّم أفلام العقارات من مساحة عمل هادئة واحدة.", newProject: "مشروع جديد", emptyTitle: "عقارك التالي يستحق لقطة قريبة.", emptyBody: "ابدأ مشروعاً بمجموعة من صور العقار أو فيديو جولة. ستتمكن من مراجعة الاتجاه قبل بدء الإنتاج.", emptyAction: "ابدأ مشروعاً", statuses: "مراحل المشروع", view: "عرض المشروع", recent: "آخر التحديثات" },
    upload: { eyebrow: "مشروع جديد", title: "ابدأ المشهد.", body: "أضف صور العقار وموجز العرض القصير الذي يحتاجه مشروعك.", media: "وسائط العقار", mediaHint: "ارفع 3–10 صور أو فيديو جولة واحداً. JPG، PNG، WEBP، MP4 أو MOV؛ حتى 25 ميغابايت إجمالاً.", drop: "أفلت الوسائط هنا", browse: "أو تصفح الملفات", titleField: "عنوان العقار", titlePlace: "مثال: بنتهاوس بحري في نخلة جميرا", description: "وصف العرض", descriptionPlace: "بعض التفاصيل لتثبيت القصة…", location: "الموقع", locationPlace: "دبي مارينا، دبي", continue: "إنشاء المشروع", processing: "جارٍ إعداد مشروعك…", remove: "إزالة" },
    review: { eyebrow: "مراجعة المشروع", title: "شكّل القصة قبل أن تتحرك.", body: "راجع وسائط العقار المرفوعة. وافق على الاتجاه لبدء إنتاج الذكاء الاصطناعي أو اترك ملاحظة للتغيير.", approve: "وافق وابدأ التوليد", request: "اطلب تعديلات", note: "ما الذي ترغب بتغييره؟", notePlace: "مثال: ابدأ بالشرفة، ثم انتقل إلى مساحة المعيشة الرئيسية.", send: "أرسل الطلب", media: "وسائط العقار", changeSent: "تم حفظ طلب التعديل" },
