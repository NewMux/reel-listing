...
export const copy = {
  en: {
    ...
    pricing: { eyebrow: "Clear by design", title: "Plans for the way you work.", body: "You buy clip credits. One property photo becomes one cinematic clip, so a ten-photo reel costs ten credits and a short three-photo teaser costs three. Nothing expires mid-month on you.", monthly: "Monthly", choose: "Talk to us", compare: "Compare every detail", perMonth: "/ month", mostPopular: "Most popular", supportValues: ["Email", "Priority", "Dedicated"], swipeHint: "Swipe to compare →", creditNote: "Credits are per clip. A full ten-photo listing reel uses 10 credits.", plans: [
      ["Solo", "$99", "For focused launches", "30 clip credits each month", "About 3 full listing reels", "Branded delivery", "Email support"],
      ["Pro", "$249", "For agents with regular volume", "80 clip credits each month", "About 8 full listing reels", "Priority generation", "Priority support"],
      ["Agency", "$599", "For growing property teams", "200 clip credits each month", "About 20 full listing reels", "Team workspace", "Extra credits at $4 each", "Dedicated success support"],
    ], comparison: ["Clip credits / month", "Full listing reels", "Team members", "Priority support"] },
    ...
    billing: { creditsLabel: "Clip credits", creditsUnit: "credits", emptyHint: "Contact us to add credits before rendering.", needCredits: "This reel needs {needed} clip credits and you have {have}. Contact us to top up before approving.", costNote: "Approving spends {needed} clip credits." },
    shot: { movementLabel: "Camera movement", roomLabel: "This room is", advanced: "Describe it myself", advancedHint: "Plain English. Crane, drone, orbit and tilt moves are not supported — they come back warped.", freeEditsNote: "Change anything you like — edits are free. You are only charged when you approve.", rooms: { unknown: "Let the AI decide", "outdoor-view": "Outdoor or view", "living-room": "Living room", "kitchen-dining": "Kitchen or dining", bedroom: "Bedroom", bathroom: "Bathroom", detail: "Detail shot" }, moves: { "push-in": "Move in closer", "pull-back": "Show the whole room", "glide-across": "Glide across", "curve-around": "Curve around", "toward-the-light": "Head for the light", "over-the-detail": "Ease over the detail" } },
  ...
  ar: {
    ...
    pricing: { eyebrow: "وضوح في كل التفاصيل", title: "خطط تناسب طريقة عملك.", body: "أنت تشتري أرصدة مقاطع. كل صورة للعقار تتحول إلى مقطع سينمائي واحد، لذا يكلّف الفيلم المكوّن من عشر صور عشرة أرصدة، ويكلّف التشويق المكوّن من ثلاث صور ثلاثة أرصدة.", monthly: "شهري", choose: "تواصل معنا", compare: "قارن كل التفاصيل", perMonth: "/ شهرياً", mostPopular: "الأكثر اختياراً", supportValues: ["البريد الإلكتروني", "بأولوية", "مخصص"], swipeHint: "← مرر لمقارنة الخطط", creditNote: "الأرصدة تُحسب لكل مقطع. الفيلم الكامل المكوّن من عشر صور يستهلك 10 أرصدة.", plans: [["Solo", "$99", "لإطلاقات مركزة", "30 رصيد مقطع شهرياً", "نحو 3 أفلام عقارية كاملة", "تسليم بعلامتك", "دعم عبر البريد"], ["Pro", "$249", "للوكلاء ذوي الإنتاج المنتظم", "80 رصيد مقطع شهرياً", "نحو 8 أفلام عقارية كاملة", "توليد بأولوية", "دعم بأولوية"], ["Agency", "$599", "لفرق العقارات المتنامية", "200 رصيد مقطع شهرياً", "نحو 20 فيلماً عقارياً كاملاً", "مساحة عمل للفريق", "أرصدة إضافية بـ$4 للرصيد", "دعم نجاح مخصص"]], comparison: ["أرصدة المقاطع / شهر", "الأفلام العقارية الكاملة", "أعضاء الفريق", "دعم بأولوية"] },
    ...
    billing: { creditsLabel: "أرصدة المقاطع", creditsUnit: "رصيد", emptyHint: "تواصل معنا لإضافة أرصدة قبل التوليد.", needCredits: "يحتاج هذا الفيلم إلى {needed} رصيد مقطع ولديك {have}. تواصل معنا لإضافة رصيد قبل الموافقة.", costNote: "الموافقة تستهلك {needed} رصيد مقطع." },
    shot: { movementLabel: "حركة الكاميرا", roomLabel: "هذه الغرفة هي", advanced: "سأصفها بنفسي", advancedHint: "بلغة بسيطة. حركات الرافعة والطائرة والدوران والإمالة غير مدعومة — تأتي النتيجة مشوّهة.", freeEditsNote: "غيّر ما تشاء — التعديلات مجانية. لا تُحتسب التكلفة إلا عند الموافقة.", rooms: { unknown: "دع الذكاء الاصطناعي يقرر", "outdoor-view": "خارجي أو إطلالة", "living-room": "غرفة المعيشة", "kitchen-dining": "مطبخ أو طعام", bedroom: "غرفة نوم", bathroom: "حمّام", detail: "لقطة تفصيلية" }, moves: { "push-in": "اقترب أكثر", "pull-back": "أظهر الغرفة كاملة", "glide-across": "انزلق عبر الغرفة", "curve-around": "در حول العنصر", "toward-the-light": "اتجه نحو الضوء", "over-the-detail": "مرّ فوق التفصيل" } },
