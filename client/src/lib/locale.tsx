...
export const copy = {
  ...
  ar: {
    ...
    pricing: { eyebrow: "وضوح في كل التفاصيل", title: "خطط تناسب طريقة عملك.", body: "أنت تشتري أرصدة. الرصيد الواحد يعادل خمس ثوانٍ من الفيديو النهائي، لذا يكلّف الفيلم المكوّن من عشر صور بلقطات من عشر ثوانٍ عشرين رصيداً، بينما يكلّف النمط السريع نصف ذلك.", monthly: "شهري", choose: "تواصل معنا", compare: "قارن كل التفاصيل", perMonth: "/ شهرياً", mostPopular: "الأكثر اختياراً", supportValues: ["البريد الإلكتروني", "بأولوية", "مخصص"], swipeHint: "← مرر لمقارنة الخطط", creditNote: "رصيد واحد = 5 ثوانٍ من الفيديو. الفيلم الكامل المكوّن من عشر صور يستهلك 20 رصيداً.", plans: [["Solo", "35 د.ب", "لإطلاقات مركزة", "60 رصيداً شهرياً", "نحو 3 أفلام عقارية كاملة", "تسليم بعلامتك", "دعم عبر البريد"], ["Pro", "94 د.ب", "للوكلاء ذوي الإنتاج المنتظم", "160 رصيداً شهرياً", "نحو 8 أفلام عقارية كاملة", "توليد بأولوية", "دعم بأولوية"], ["Agency", "225 د.ب", "لفرق العقارات المتنامية", "400 رصيد شهرياً", "نحو 20 فيلماً عقارياً كاملاً", "مساحة عمل للفريق", "أرصدة إضافية بـ0.750 د.ب للرصيد", "دعم نجاح مخصص"]], comparison: ["الأرصدة / شهر", "الأفلام العقارية الكاملة", "أعضاء الفريق", "دعم بأولوية"] },
