...
export const copy = {
  en: {
    ...
    contact: { eyebrow: "Get in touch", title: "Contact us", body: "Have a question about a listing, pricing, or how the studio works? Reach our team directly — we usually reply the same day.", badgeTitle: "AI direction ready", badgeBody: "Review before it renders", addressLabel: "Address", emailLabel: "Email", phoneLabel: "Phone", whatsapp: "Contact via WhatsApp" },
  ...
  ar: {
    ...
    contact: { eyebrow: "تواصل معنا", title: "اتصل بنا", body: "هل لديك سؤال حول أحد العقارات، أو الأسعار، أو طريقة عمل الاستوديو؟ تواصل مع فريقنا مباشرة — عادةً ما نرد في نفس اليوم.", badgeTitle: "التوجيه بالذكاء الاصطناعي جاهز", badgeBody: "راجعه قبل أن يتم إنتاجه", addressLabel: "العنوان", emailLabel: "البريد الإلكتروني", phoneLabel: "الهاتف", whatsapp: "تواصل عبر واتساب" },
