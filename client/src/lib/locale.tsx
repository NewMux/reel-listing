...
export const copy = {
  en: {
    nav: { product: "Product", pricing: "Pricing", contact: "Contact", signIn: "Sign in", dashboard: "Open dashboard", account: "Account", language: "العربية" },
    auth: {
    ...
    pricing: { eyebrow: "Clear by design", title: "Plans for the way you work.", body: "Choose a starting point for your listing portfolio. Scale when your production volume grows.", choose: "Choose plan", perMonth: "/ month", videosPerMonth: "video projects / month", empty: "Plans are being finalized — check back soon.", loading: "Loading plans…" },
    billing: {
      title: "Your plan",
      noSubscription: "You don't have an active subscription yet.",
      choosePlan: "Choose a plan",
      status: { active: "Active", trialing: "Trial", past_due: "Payment due", paused: "Paused", canceled: "Canceled" },
      renewsLabel: "Renews on", endsLabel: "Access ends on",
      cancelButton: "Cancel subscription",
      cancelConfirmTitle: "Cancel your subscription?",
      cancelConfirmBody: "You'll keep your plan and remaining credits until the end of the current billing period. This can't be undone from here.",
      cancelConfirmAction: "Yes, cancel", cancelConfirmCancel: "Never mind",
      cancelSuccess: "Your subscription will end at the close of the current period.",
      cancelError: "Unable to cancel your subscription right now.",
      videosRemaining: "Videos remaining",
      topupsTitle: "Need more credits?", topupsBody: "Buy extra videos any time.",
      buy: "Buy", checkoutError: "Unable to start checkout right now.", checkoutUnavailable: "Checkout is not available right now.",
    },
  ...
  ar: {
    nav: { product: "المنتج", pricing: "الأسعار", contact: "تواصل معنا", signIn: "تسجيل الدخول", dashboard: "لوحة التحكم", account: "الحساب", language: "English" },
    auth: {
    ...
    pricing: { eyebrow: "وضوح في كل التفاصيل", title: "خطط تناسب طريقة عملك.", body: "اختر نقطة البداية المناسبة لمحفظتك العقارية، ثم ارتقِ عندما يتوسع حجم الإنتاج.", choose: "اختر الخطة", perMonth: "/ شهرياً", videosPerMonth: "مشاريع فيديو / شهر", empty: "يتم الآن وضع اللمسات الأخيرة على الخطط — تحقق قريباً.", loading: "جارٍ تحميل الخطط…" },
    billing: {
      title: "خطتك",
      noSubscription: "ليس لديك اشتراك فعّال حالياً.",
      choosePlan: "اختر خطة",
      status: { active: "فعّال", trialing: "فترة تجريبية", past_due: "دفعة مستحقة", paused: "متوقف مؤقتاً", canceled: "ملغى" },
      renewsLabel: "يتجدد في", endsLabel: "ينتهي الوصول في",
      cancelButton: "إلغاء الاشتراك",
      cancelConfirmTitle: "هل تريد إلغاء اشتراكك؟",
      cancelConfirmBody: "ستحتفظ بخطتك ورصيدك المتبقي حتى نهاية فترة الفوترة الحالية. لا يمكن التراجع عن هذا من هنا.",
      cancelConfirmAction: "نعم، ألغِ", cancelConfirmCancel: "تراجع",
      cancelSuccess: "سينتهي اشتراكك في نهاية الفترة الحالية.",
      cancelError: "تعذّر إلغاء اشتراكك في الوقت الحالي.",
      videosRemaining: "الفيديوهات المتبقية",
      topupsTitle: "بحاجة لمزيد من الرصيد؟", topupsBody: "اشترِ فيديوهات إضافية في أي وقت.",
      buy: "شراء", checkoutError: "تعذّر بدء عملية الدفع في الوقت الحالي.", checkoutUnavailable: "عملية الدفع غير متاحة حالياً.",
    },
