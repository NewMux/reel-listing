...
export const copy = {
  en: {
    ...
    pricing: { eyebrow: "Clear by design", title: "Plans for the way you work.", body: "Choose a starting point for your listing portfolio. Scale when your production volume grows.", choose: "Choose plan", perMonth: "/ month", videosPerMonth: "video projects / month", stagingPerMonth: "staging credits / month", empty: "Plans are being finalized — check back soon.", loading: "Loading plans…" },
    billing: {
      title: "Your plan",
      ...
      videosRemaining: "Videos remaining", stagingCreditsRemaining: "Staging credits remaining",
      topupsTitle: "Need more credits?", topupsBody: "Buy extra videos or staging credits any time.",
  ...
  ar: {
    ...
    pricing: { eyebrow: "وضوح في كل التفاصيل", title: "خطط تناسب طريقة عملك.", body: "اختر نقطة البداية المناسبة لمحفظتك العقارية، ثم ارتقِ عندما يتوسع حجم الإنتاج.", choose: "اختر الخطة", perMonth: "/ شهرياً", videosPerMonth: "مشاريع فيديو / شهر", stagingPerMonth: "رصيد تجهيز / شهر", empty: "يتم الآن وضع اللمسات الأخيرة على الخطط — تحقق قريباً.", loading: "جارٍ تحميل الخطط…" },
    billing: {
      title: "خطتك",
      ...
      videosRemaining: "الفيديوهات المتبقية", stagingCreditsRemaining: "رصيد التجهيز المتبقي",
      topupsTitle: "بحاجة لمزيد من الرصيد؟", topupsBody: "اشترِ فيديوهات أو رصيد تجهيز إضافي في أي وقت.",
