...
export const copy = {
  en: {
    ...
    pricing: { eyebrow: "Clear by design", title: "Plans for the way you work.", body: "You buy clip credits. One property photo becomes one cinematic clip, so a ten-photo reel costs ten credits and a short three-photo teaser costs three. Nothing expires mid-month on you.", monthly: "Monthly", choose: "Talk to us", compare: "Compare every detail", perMonth: "/ month", mostPopular: "Most popular", supportValues: ["Email", "Priority", "Dedicated"], swipeHint: "Swipe to compare →", creditNote: "Credits are per clip. A full ten-photo listing reel uses 10 credits.", plans: [
      ["Starter", "$99", "For focused launches", "30 clip credits each month", "About 3 full listing reels", "Branded delivery", "Email support"],
