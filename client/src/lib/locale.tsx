...
export const copy = {
  en: {
    ...
    pricing: { eyebrow: "Clear by design", title: "Plans for the way you work.", body: "Choose a starting point for your listing portfolio. Scale when your production volume grows.", monthly: "Monthly", choose: "Choose plan", compare: "Compare every detail", perMonth: "/ month", mostPopular: "Most popular", supportValues: ["Email", "Priority", "Dedicated"], swipeHint: "Swipe to compare →", unavailable: "Coming soon", loading: "Loading plans…",
      // Prices, allowances and Paddle price IDs come from shared/plans.ts via the
      // billing.plans query. Only display copy lives here, so the two languages and the
      // comparison table can no longer drift apart from what we actually charge.
      names: { starter: "Starter", pro: "Pro", agency: "Agency" },
      taglines: { starter: "For focused launches", pro: "For agents with regular volume", agency: "For growing property teams" },
      videosPerMonth: "video projects each month", stagingPerMonth: "virtual staging credits each month",
      planFeatures: { starter: ["Standard generation", "Branded delivery", "Email support"], pro: ["Priority generation", "Priority support"], agency: ["Team workspace", "Dedicated success support"] },
      comparison: ["Video projects / month", "Staging credits / month", "Priority support"],
      packTitle: "Not ready for a plan?", packBody: "Buy a one-time bundle of listings instead. Pack credits never expire.", packCta: "Buy pack", packVideos: "listing videos",
      // Paddle charges in USD; BHD is shown at the Central Bank of Bahrain's fixed peg
      // purely for reference. Saying otherwise would misstate what the card is billed.
      bhdNote: "Billed in USD. BHD shown for reference at the fixed CBB rate." },
    billing: { title: "Billing", body: "Your plan, your credits, and your invoices.", creditsTitle: "Render credits", videosLabel: "listing videos", stagingLabel: "staging credits", planCredits: "from your plan, resets each period", packCredits: "purchased, never expires", noPlan: "No active plan", planLabel: "Current plan", statusLabel: "Status", renewsLabel: "Renews", endsLabel: "Access ends", cancelScheduled: "Cancels at the end of this period", manage: "Manage subscription", managePending: "Opening…", manageUnavailable: "You have not made a purchase yet.", choosePlan: "Choose a plan", buyPack: "Buy a credit pack", outOfCredit: "You are out of render credit.", outOfCreditBody: "Choose a plan or buy a pack to keep producing listing films.", blocked: "Billing is on hold for this account. Please contact support.", checkoutFailed: "Could not start checkout", checkoutOpened: "Opening secure checkout…", creditsLeft: "credits left" },
  ...
  ar: {
    ...
    pricing: { eyebrow: "وضوح في كل التفاصيل", title: "خطط تناسب طريقة عملك.", body: "اختر نقطة البداية المناسبة لمحفظتك العقارية، ثم ارتقِ عندما يتوسع حجم الإنتاج.", monthly: "شهري", choose: "اختر الخطة", compare: "قارن كل التفاصيل", perMonth: "/ شهرياً", mostPopular: "الأكثر اختياراً", supportValues: ["البريد الإلكتروني", "بأولوية", "مخصص"], swipeHint: "← مرر لمقارنة الخطط", unavailable: "قريباً", loading: "جارٍ تحميل الخطط…",
      names: { starter: "Starter", pro: "Pro", agency: "Agency" },
      taglines: { starter: "لإطلاقات مركزة", pro: "للوكلاء ذوي الإنتاج المنتظم", agency: "لفرق العقارات المتنامية" },
      videosPerMonth: "مشاريع فيديو شهرياً", stagingPerMonth: "أرصدة تأثيث افتراضي شهرياً",
      planFeatures: { starter: ["توليد أساسي", "تسليم بعلامتك", "دعم عبر البريد"], pro: ["توليد بأولوية", "دعم بأولوية"], agency: ["مساحة عمل للفريق", "دعم نجاح مخصص"] },
      comparison: ["مشاريع الفيديو / شهر", "أرصدة التأثيث / شهر", "دعم بأولوية"],
      packTitle: "لست مستعداً للاشتراك؟", packBody: "اشترِ باقة مرة واحدة بدلاً من ذلك. أرصدة الباقة لا تنتهي صلاحيتها أبداً.", packCta: "شراء الباقة", packVideos: "فيديو عقاري",
      bhdNote: "تتم الفوترة بالدولار الأمريكي. المبلغ بالدينار البحريني للاسترشاد فقط وفق سعر الصرف الثابت لمصرف البحرين المركزي." },
    billing: { title: "الفوترة", body: "خطتك وأرصدتك وفواتيرك.", creditsTitle: "أرصدة الإنتاج", videosLabel: "فيديو عقاري", stagingLabel: "أرصدة التأثيث", planCredits: "من خطتك، تتجدد كل فترة", packCredits: "مشتراة، لا تنتهي صلاحيتها", noPlan: "لا توجد خطة نشطة", planLabel: "الخطة الحالية", statusLabel: "الحالة", renewsLabel: "تتجدد في", endsLabel: "ينتهي الوصول في", cancelScheduled: "سيتم الإلغاء في نهاية هذه الفترة", manage: "إدارة الاشتراك", managePending: "جارٍ الفتح…", manageUnavailable: "لم تقم بأي عملية شراء بعد.", choosePlan: "اختر خطة", buyPack: "شراء باقة أرصدة", outOfCredit: "لقد نفدت أرصدة الإنتاج لديك.", outOfCreditBody: "اختر خطة أو اشترِ باقة لمواصلة إنتاج أفلام العقارات.", blocked: "الفوترة معلّقة لهذا الحساب. يرجى التواصل مع الدعم.", checkoutFailed: "تعذّر بدء عملية الدفع", checkoutOpened: "جارٍ فتح صفحة الدفع الآمنة…", creditsLeft: "رصيد متبقٍ" },
