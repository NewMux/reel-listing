  ...
  return <div className="min-h-screen bg-[#F7F5EF] text-[#11251E]">
    ...
    <main className="mx-auto grid max-w-[1120px] gap-12 px-5 pb-20 pt-12 sm:px-8 sm:pt-20 lg:grid-cols-[.9fr_1.1fr] lg:items-center">
      <section>
        ...
        <p className="mt-6 max-w-[500px] text-base leading-7 text-[#5C6C63]">Sign in to upload 1–10 property photos, review the AI direction, and receive the finished cinematic reel in one workspace.</p>
      ...
      <section className="rounded-[28px] border border-[#11251E]/10 bg-white/85 p-6 shadow-[0_24px_70px_rgba(17,37,30,.08)] sm:p-8">
        ...
        <p className="mt-2 text-sm leading-6 text-[#6B7A71]">{mode === "signIn" ? "Continue creating refined listing films." : "Use your email to save projects and receive final reels."}</p>
