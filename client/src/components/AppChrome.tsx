...
export function Brand({ light = false }: { light?: boolean }) {
  return <Link href="/" className={`flex items-center gap-2.5 font-semibold tracking-[-.03em] ${light ? "text-[#f7f5ef]" : "text-[#11251E]"}`}><span className="grid h-8 w-8 place-items-center rounded-[10px] bg-[#C7D87A] text-[#11251E]"><Clapperboard size={16} strokeWidth={2.3} /></span><span className="text-[17px]">VistaFlow<span className="font-normal opacity-60">.ai</span></span></Link>;
}
