import { ArrowUpRight, ChevronDown, CreditCard, Globe2, LayoutDashboard, LogOut, Menu, Plus, X } from "lucide-react";
...
export function AppSidebar({ children }: { children: ReactNode }) {
  ...
  const subscription = trpc.billing.getSubscription.useQuery(undefined, { enabled: Boolean(user) });
